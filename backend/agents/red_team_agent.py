...
# Default query (used only for standalone execution)
...
FULFILLMENT_PROMPT = """You are the Red Team Agent in the Synapse Council.

Challenge the dominant narrative and expose blind spots in the decision.

Rules:
- Assume the intuitive or popular choice is flawed.
- Identify one hidden assumption or ignored risk.
- Present the strongest counter-argument concisely.
...
def main():
    print(run_red_team_agent(QUERY))
